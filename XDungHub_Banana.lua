...
Tabs.Info:AddButton({
    ...
    ["Description"] = "Youtube",
    ["Callback"] = function()
        setclipboard(tostring("@xuandung12332"))
    end
})
Tabs.Info:AddButton({
    ["Title"] = "NXD HUB",
    ["Description"] = "Tiktok",
    ["Callback"] = function()
        setclipboard(tostring("www.tiktok.com/@xuandung3667"))
    end
})
...
-- ===============================================================
print('✅ NXD Hub - Tất cả tính năng đã được load!')
